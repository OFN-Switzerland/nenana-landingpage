		...
		<div className="hidden md:block">
			{loaderData?.isDev ? (
				<div className="fixed top-2 right-2 flex flex-row gap-1 text-xs md:top-auto md:right-auto md:bottom-2 md:left-2">
					...
					<Badge className="sm:hidden md:hidden lg:hidden xl:hidden">sm (&lt; 640px)</Badge>
					<Badge className="hidden sm:inline md:hidden">sm</Badge>
					<Badge className="hidden md:inline lg:hidden">md</Badge>
					<Badge className="hidden lg:inline xl:hidden">lg</Badge>
