...
const messages = {
	de: {
		...
		footer: 'Eine Dienstleistung von NeNaNa - Netzwerk Natürliche Nahrung',
		footerLink: 'https://nenana.ch',
		greeting: 'Hallo',
		logoText: 'NeNaNa Box',
		preview: 'Registrationsformular abgesendet',
		title: 'NeNaNa Box Registrierung in Bearbeitung',
	},
	en: {
		...
		directLink: 'https://box.nenana.ch',
		directLinkText: 'To your NeNaNa Box',
		footer: 'A service from NeNaNa - Netzwerk Natürliche Nahrung (Natural Nutrition Network)',
		footerLink: 'https://nenana.ch',
		greeting: 'Hi',
		logoText: 'NeNaNa Box',
		preview: 'Registration form submitted',
		title: 'NeNaNa Box Registration in Progress',
	},
}
