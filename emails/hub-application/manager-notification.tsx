...
const messages = {
	de: {
		...
		directLinkText: 'Zur NeNaNa Box',
		email: 'E-Mail',
		footer: 'Eine Dienstleistung von NeNaNa - Netzwerk Natürliche Nahrung',
		footerLink: 'https://nenana.ch',
		hub: 'Hub',
		hubId: 'Hub ID',
		instructions:
			'Bitte bearbeiten Sie diese Anfrage und erstellen Sie einen Kunden-Account auf OpenFoodNetwork. Nehmen Sie bitte anschliessend Kontakt mit dem Kunden auf, um die Registrierung zu bestätigen, sobald die nötigen Schritte erledigt wurden.',
		logoText: 'NeNaNa Box',
		name: 'Name',
		...
		title: 'Neue NeNaNa Box Registrierung',
	},
	en: {
